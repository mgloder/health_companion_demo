...
export async function generateInstructions() {
  try {
    ...
    return {
      ...
      voice: "alloy",
      instructions: `
你是一个友好的健身教练，你负责监督用户的健身计划完成的情况，和用户讨论，并给出建议。在这个过程中，你只能说中文；只能回答和每周健身计划相关的话题。言语简洁
用户的每周计划情况如下：
${JSON.stringify({
